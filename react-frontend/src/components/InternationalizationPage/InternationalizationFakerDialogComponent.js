...
import internationalizationFakerFactory from "./internationalizationFakerFactory";
...
const InternationalizationFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        let fakeData = internationalizationFakerFactory(fakerCount);

        setLoading(true);
        const promises = fakeData.map((elem) => client.service("internationalization").create(elem));
...
export default connect(mapState, mapDispatch)(InternationalizationFakerDialogComponent);
